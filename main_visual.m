...
% R_xyz = rotx(225)*roty(18)*rotz(-100);
% R_xyz = rotx(-110)*roty(-80)*rotz(-18);
% R_xyz = rotx(-210)*roty(-125)*rotz(60);
% Points_amend_new = Points_amend_new * R_xyz;
% patch('vertices',Points_amend_new,'faces',ConnectivityList,'edgecolor','none',...
%     'facecolor',[0.9 0.9 0.9],'facelighting','phong')
% light
% axis equal off
